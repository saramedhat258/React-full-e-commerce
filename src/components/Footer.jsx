        ...
        <>
            <section className="h-96 w-full mt-10" style={{ backgroundImage: `url(${assetsimg.footer})`, backgroundSize: 'cover' }}>
                <section className="mx-auto pt-32 w-2/3 text-center">
                    ...
                    <input placeholder="email address" type="text" className="md:w-1/2 w-11/12 mt-7 border-b-2 pb-3 placeholder:text-slate-400 border-slate-300 mx-auto outline-none bg-transparent " />
                </section>
            </section>
            <MinFooter />
        </>
